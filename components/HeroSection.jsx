    ...
    <>
      <section id="home" className="relative min-h-screen overflow-hidden bg-[#242329] text-white">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('/everhaul-hero.jpg')] bg-cover bg-[center_right] opacity-[0.42]" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#242329] via-[#242329]/82 to-[#242329]/45" />
